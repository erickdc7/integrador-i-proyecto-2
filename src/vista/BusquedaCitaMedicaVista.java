...
public class BusquedaCitaMedicaVista extends javax.swing.JFrame {

    public BusquedaCitaMedicaVista() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tblCitaMedica = new javax.swing.JTable();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Búsqueda de cita médica");
        setResizable(false);
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 220, 190, 25));
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 300, 170, 25));
        ...
        jLabel11.setText("Búsqueda de historia médica");
        ...
        bg.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 250, 560));
        ...
        jLabel1.setText("Búsqueda de cita médica");
        ...
        jLabel2.setText("Busque la cita médica ingresando el DNI del paciente.");
        ...
        tblCitaMedica.setForeground(new java.awt.Color(18, 23, 33));
        tblCitaMedica.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        bg.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 0, 500, 560));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BusquedaCitaMedicaVista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BusquedaCitaMedicaVista().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tblCitaMedica;
